...
export default function TarefaCard(props: Tarefa){
    ...
    return (
        <div className="flex flex-row gap-1 w-full rounded-xl bg-gray-200 shadow-2xl hover:bg-gray-300 hover:scale-[101%] transition-all ease-in-out duration-300 p-4 text-black" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
