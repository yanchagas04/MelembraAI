...
export default function BarraLateral(props: BarraLateralProps) {
    ...
    return (
        <nav className={`${open ? "md:w-64" : "md:w-24"} flex flex-col items-center justify-between py-4 px-2 md:h-screen bg-blue-500 gap-4 transition-all ease-in-out duration-150`} onMouseEnter={() => setOpen(true)} onMouseLeave={() => setOpen(false)}>
